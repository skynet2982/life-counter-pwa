(() => {
  ...
  const translations = {
    en: {
      ...
      gameMode: "Game mode",
      chooseStartingPlayer: "Choose starting player",
      selectGameMode: "Select game mode",
      twoPlayers: "2 Players",
      threePlayers: "3 Players",
      fourPlayers: "4 Players",
      selectFourPlayerLayout: "Select 4-player layout",
      layoutSides: "2 per side",
      layoutCorners: "Sides + middle",
      shareApp: "Share app",
    ...
    fr: {
      ...
      chooseStartingPlayer: "Choisir le joueur qui commence",
      selectGameMode: "Choisir le mode de jeu",
      twoPlayers: "2 Joueurs",
      threePlayers: "3 Joueurs",
      fourPlayers: "4 Joueurs",
      selectFourPlayerLayout: "Choisir la disposition à 4 joueurs",
      layoutSides: "2 par côté",
      layoutCorners: "Extérieur + milieu",
